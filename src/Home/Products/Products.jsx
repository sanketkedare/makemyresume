...
const Products = ({ typeR }) => {
  ...
  return (
    <div className="lg:flex justify-center items-center mt-10">
      ...
      <div className="w-[100%] lg:w-[50%] m-auto mt-2 lg:h-[400px] h-[250px]">

        <h1 className="text-lg text-sky-500 font-bold capitalize bg-inherit">{normalResume.info}</h1>

        <div className="lg:mt-3 text-sm text-justify h-[60%] overflow-y-auto">
